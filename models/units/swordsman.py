...
class Swordsman(Unit):
    def __init__(self, x, y, map_instance, player_id=1, use_terminal_view=False):
        super().__init__(x, y, unit_type="Swordsman", attack_speed=4, speed=0.9, hp=40, map=map_instance)
    ...
    def initialize_sprites(self):
        ...
        self.attack_sprites = self.asset_manager.swordsman_sprites.get('attack', [])
        self.walking_sprites = self.asset_manager.swordsman_sprites.get('walking', [])
        self.standing_sprites = self.asset_manager.swordsman_sprites.get('standing', [])
